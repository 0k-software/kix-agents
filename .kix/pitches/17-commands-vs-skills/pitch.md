...
created_at: 2026-05-05T15:07:06Z
updated_at: 2026-05-05T15:07:06Z
---

# Commands vs skills for Kix flows

## Summary

Both Requests question whether Kix flows belong in `commands/` or as skills.
Request 2 asks why we picked the `commands/` folder over skills in the first
place; Request 16 reports that natural-language phrasings like "commit" or
"commit this" do not trigger the Kix commit flow, suspecting that slash
commands cannot match on intent the way skills can.
